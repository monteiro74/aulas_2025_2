...
|9| Recursos Externos           | 4.2. Formatos de Arquivos Externos                     | Definições de formato         | Especificam como ler arquivos externos (CSV, Parquet, ORC) pelo PolyBase.           |
...
|13| Programação                 | 6.4. Assemblies                                        | Integração com .NET           | Permitem rodar código CLR (C#, VB.NET) dentro do SQL Server.                        |
